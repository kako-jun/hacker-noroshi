  ...
  "about": ""
	...
	<table style="font-size: 9pt; border-collapse: collapse;">
		<tbody>
			...
			<tr><td style="padding: 1pt 8pt 1pt 0;"><code>type</code></td><td>One of <code>story</code>, <code>comment</code>, <code>ask</code>, <code>show</code>, <code>poll</code>, <code>job</code>.</td></tr>
			<tr><td style="padding: 1pt 8pt 1pt 0;"><code>by</code></td><td>Author username.</td></tr>
			...
			<tr><td style="padding: 1pt 8pt 1pt 0;"><code>kids</code></td><td>IDs of immediate child comments. One level only — recurse via <code>/item/&lt;id&gt;.json</code> per kid.</td></tr>
			...
			<tr><td style="padding: 1pt 8pt 1pt 0;"><code>deleted</code></td><td><code>true</code> if the author deleted their account. The username is preserved (HN parity).</td></tr>
	...
	<p>
		...
		Internal failures return <code>500</code> with body <code>{"error": "internal"}</code>.
	</p>
